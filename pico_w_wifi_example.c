...
void create_http_response()
{
    snprintf(http_response, sizeof(http_response),
             ...
             "    <h1 style=\"color: #333; text-align: center;\">Monitoramento de Temperatura e Botões</h1>"
             "    <p style=\"text-align: center;\"><a href=\"/update\" style=\"color: #007bff; text-decoration: none;\">Atualizar Estado</a></p>"
             "    <h2 style=\"color: #444;\">Estado dos Botões:</h2>"
             "    <p>Botão 1: %s</p>"
             "    <p>Botão 2: %s</p>"
             "    <h2 style=\"color: #444;\">Temperatura:</h2>"
...
int main()
{
    ...
    // Inicia servidor
    start_http_server();
      // Adiciona leitura e exibição da temperatura no terminal
      float temp = read_temperature_celsius();
